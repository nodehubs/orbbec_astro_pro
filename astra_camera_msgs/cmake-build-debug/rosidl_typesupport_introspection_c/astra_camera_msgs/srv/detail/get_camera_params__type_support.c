...
void GetCameraParams_Request__rosidl_typesupport_introspection_c__GetCameraParams_Request_init_function(
...
void GetCameraParams_Request__rosidl_typesupport_introspection_c__GetCameraParams_Request_fini_function(void * message_memory)
{
  astra_camera_msgs__srv__GetCameraParams_Request__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetCameraParams_Request__rosidl_typesupport_introspection_c__GetCameraParams_Request_message_member_array[1] = {
  {
...
static const rosidl_typesupport_introspection_c__MessageMembers GetCameraParams_Request__rosidl_typesupport_introspection_c__GetCameraParams_Request_message_members = {
  ...
  GetCameraParams_Request__rosidl_typesupport_introspection_c__GetCameraParams_Request_message_member_array,  // message members
  GetCameraParams_Request__rosidl_typesupport_introspection_c__GetCameraParams_Request_init_function,  // function to initialize message memory (memory has to be allocated)
  GetCameraParams_Request__rosidl_typesupport_introspection_c__GetCameraParams_Request_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetCameraParams_Request__rosidl_typesupport_introspection_c__GetCameraParams_Request_message_type_support_handle = {
  0,
  &GetCameraParams_Request__rosidl_typesupport_introspection_c__GetCameraParams_Request_message_members,
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, astra_camera_msgs, srv, GetCameraParams_Request)() {
  if (!GetCameraParams_Request__rosidl_typesupport_introspection_c__GetCameraParams_Request_message_type_support_handle.typesupport_identifier) {
    GetCameraParams_Request__rosidl_typesupport_introspection_c__GetCameraParams_Request_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetCameraParams_Request__rosidl_typesupport_introspection_c__GetCameraParams_Request_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
...
void GetCameraParams_Response__rosidl_typesupport_introspection_c__GetCameraParams_Response_init_function(
  void * message_memory, enum rosidl_runtime_c__message_initialization _init)
{
  // TODO(karsten1987): initializers are not yet implemented for typesupport c
  // see https://github.com/ros2/ros2/issues/397
...
void GetCameraParams_Response__rosidl_typesupport_introspection_c__GetCameraParams_Response_fini_function(void * message_memory)
{
  astra_camera_msgs__srv__GetCameraParams_Response__fini(message_memory);
}

static rosidl_typesupport_introspection_c__MessageMember GetCameraParams_Response__rosidl_typesupport_introspection_c__GetCameraParams_Response_message_member_array[8] = {
  {
    "l_intr_p",  // name
...
static const rosidl_typesupport_introspection_c__MessageMembers GetCameraParams_Response__rosidl_typesupport_introspection_c__GetCameraParams_Response_message_members = {
  "astra_camera_msgs__srv",  // message namespace
  "GetCameraParams_Response",  // message name
  8,  // number of fields
  sizeof(astra_camera_msgs__srv__GetCameraParams_Response),
  GetCameraParams_Response__rosidl_typesupport_introspection_c__GetCameraParams_Response_message_member_array,  // message members
  GetCameraParams_Response__rosidl_typesupport_introspection_c__GetCameraParams_Response_init_function,  // function to initialize message memory (memory has to be allocated)
  GetCameraParams_Response__rosidl_typesupport_introspection_c__GetCameraParams_Response_fini_function  // function to terminate message instance (will not free memory)
};

// this is not const since it must be initialized on first access
// since C does not allow non-integral compile-time constants
static rosidl_message_type_support_t GetCameraParams_Response__rosidl_typesupport_introspection_c__GetCameraParams_Response_message_type_support_handle = {
  0,
  &GetCameraParams_Response__rosidl_typesupport_introspection_c__GetCameraParams_Response_message_members,
  get_message_typesupport_handle_function,
};
...
ROSIDL_TYPESUPPORT_INTERFACE__MESSAGE_SYMBOL_NAME(rosidl_typesupport_introspection_c, astra_camera_msgs, srv, GetCameraParams_Response)() {
  if (!GetCameraParams_Response__rosidl_typesupport_introspection_c__GetCameraParams_Response_message_type_support_handle.typesupport_identifier) {
    GetCameraParams_Response__rosidl_typesupport_introspection_c__GetCameraParams_Response_message_type_support_handle.typesupport_identifier =
      rosidl_typesupport_introspection_c__identifier;
  }
  return &GetCameraParams_Response__rosidl_typesupport_introspection_c__GetCameraParams_Response_message_type_support_handle;
}
#ifdef __cplusplus
}
#endif
