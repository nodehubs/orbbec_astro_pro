...
{
  astra_camera_msgs__msg__DeviceInfo * msg = (astra_camera_msgs__msg__DeviceInfo *)malloc(sizeof(astra_camera_msgs__msg__DeviceInfo));
  if (!msg) {
    return NULL;
  }
...
astra_camera_msgs__msg__DeviceInfo__Sequence__init(astra_camera_msgs__msg__DeviceInfo__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (astra_camera_msgs__msg__DeviceInfo *)calloc(size, sizeof(astra_camera_msgs__msg__DeviceInfo));
    if (!data) {
      return false;
    }
...
{
  astra_camera_msgs__msg__DeviceInfo__Sequence * array = (astra_camera_msgs__msg__DeviceInfo__Sequence *)malloc(sizeof(astra_camera_msgs__msg__DeviceInfo__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  astra_camera_msgs__msg__DeviceInfo__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    astra_camera_msgs__msg__DeviceInfo * data =
      (astra_camera_msgs__msg__DeviceInfo *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!astra_camera_msgs__msg__DeviceInfo__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          astra_camera_msgs__msg__DeviceInfo__fini(&data[i]);
        }
        free(data);
        return false;
      }
