...
{
  astra_camera_msgs__srv__GetDeviceInfo_Request * msg = (astra_camera_msgs__srv__GetDeviceInfo_Request *)malloc(sizeof(astra_camera_msgs__srv__GetDeviceInfo_Request));
  if (!msg) {
    return NULL;
  }
...
astra_camera_msgs__srv__GetDeviceInfo_Request__Sequence__init(astra_camera_msgs__srv__GetDeviceInfo_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (astra_camera_msgs__srv__GetDeviceInfo_Request *)calloc(size, sizeof(astra_camera_msgs__srv__GetDeviceInfo_Request));
    if (!data) {
      return false;
    }
...
{
  astra_camera_msgs__srv__GetDeviceInfo_Request__Sequence * array = (astra_camera_msgs__srv__GetDeviceInfo_Request__Sequence *)malloc(sizeof(astra_camera_msgs__srv__GetDeviceInfo_Request__Sequence));
  if (!array) {
    return NULL;
  }
...
{
  astra_camera_msgs__srv__GetDeviceInfo_Response * msg = (astra_camera_msgs__srv__GetDeviceInfo_Response *)malloc(sizeof(astra_camera_msgs__srv__GetDeviceInfo_Response));
  if (!msg) {
    return NULL;
  }
...
astra_camera_msgs__srv__GetDeviceInfo_Response__Sequence__init(astra_camera_msgs__srv__GetDeviceInfo_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (astra_camera_msgs__srv__GetDeviceInfo_Response *)calloc(size, sizeof(astra_camera_msgs__srv__GetDeviceInfo_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  astra_camera_msgs__srv__GetDeviceInfo_Response__Sequence * array = (astra_camera_msgs__srv__GetDeviceInfo_Response__Sequence *)malloc(sizeof(astra_camera_msgs__srv__GetDeviceInfo_Response__Sequence));
  if (!array) {
    return NULL;
  }
