...
{
  astra_camera_msgs__srv__GetString_Request * msg = (astra_camera_msgs__srv__GetString_Request *)malloc(sizeof(astra_camera_msgs__srv__GetString_Request));
  if (!msg) {
    return NULL;
  }
...
astra_camera_msgs__srv__GetString_Request__Sequence__init(astra_camera_msgs__srv__GetString_Request__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (astra_camera_msgs__srv__GetString_Request *)calloc(size, sizeof(astra_camera_msgs__srv__GetString_Request));
    if (!data) {
      return false;
    }
...
{
  astra_camera_msgs__srv__GetString_Request__Sequence * array = (astra_camera_msgs__srv__GetString_Request__Sequence *)malloc(sizeof(astra_camera_msgs__srv__GetString_Request__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  astra_camera_msgs__srv__GetString_Request__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    astra_camera_msgs__srv__GetString_Request * data =
      (astra_camera_msgs__srv__GetString_Request *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!astra_camera_msgs__srv__GetString_Request__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          astra_camera_msgs__srv__GetString_Request__fini(&data[i]);
        }
        free(data);
        return false;
      }
...
{
  astra_camera_msgs__srv__GetString_Response * msg = (astra_camera_msgs__srv__GetString_Response *)malloc(sizeof(astra_camera_msgs__srv__GetString_Response));
  if (!msg) {
    return NULL;
  }
...
astra_camera_msgs__srv__GetString_Response__Sequence__init(astra_camera_msgs__srv__GetString_Response__Sequence * array, size_t size)
{
  ...
  if (size) {
    data = (astra_camera_msgs__srv__GetString_Response *)calloc(size, sizeof(astra_camera_msgs__srv__GetString_Response));
    if (!data) {
      return false;
    }
    // initialize all array elements
...
{
  astra_camera_msgs__srv__GetString_Response__Sequence * array = (astra_camera_msgs__srv__GetString_Response__Sequence *)malloc(sizeof(astra_camera_msgs__srv__GetString_Response__Sequence));
  if (!array) {
    return NULL;
  }
  ...
  astra_camera_msgs__srv__GetString_Response__Sequence * output)
{
  ...
  if (output->capacity < input->size) {
    ...
    astra_camera_msgs__srv__GetString_Response * data =
      (astra_camera_msgs__srv__GetString_Response *)realloc(output->data, allocation_size);
    if (!data) {
      return false;
    }
    for (size_t i = output->capacity; i < input->size; ++i) {
      if (!astra_camera_msgs__srv__GetString_Response__init(&data[i])) {
        /* free currently allocated and return false */
        for (; i-- > output->capacity; ) {
          astra_camera_msgs__srv__GetString_Response__fini(&data[i]);
        }
        free(data);
        return false;
      }
